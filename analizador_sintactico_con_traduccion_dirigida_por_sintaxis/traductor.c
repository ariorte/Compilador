/*=================Incluye al analizador sintáctico================*/
#include "sintactico.c"
/*=================================================================*/

/*===========Archivo de salida que contendrá la traducción=========*/
FILE *archivoXML;
/*=================================================================*/
...
void attValueTrad();
/*==================================================================*/
int tabulacion=0;  // Simulación de presión de tabulación.

/*=====Procedimiento que realiza la tabulación en el archivo de salida====*/
void print_tab(){
    int i=0;
...
/*
 * Programa principal que realiza la traducción del archivo fuente recibido,
 * dando como salida otro archivo denominado 'output.xml' que sería la
 * traducción. Únicamente eso se realizará si se recibe el archivo fuente y la
 * misma no contiene algún tipo de error (léxico o sintáctico), y si fuese caso
 * de error la misma indica en el archivo de salida el tipo error, pero con
 * mayor detalles se puede observar en la terminal.
*/
int main (int argc,char* args[]){
    if(argc > 1)
    {
		...
		fprintf(archivoXML,"\nEl fuente contiene errores sintacticos.\n");
